<template>
    <div>
        <div class="card">
            ...
            <div class="card-body">
                <datePicker class="my-datePicker" calendar-class="my-datePicker_calendar" :disabledDates="disabledDates"
                 :format="customDate" v-model="time"
                inline auto-apply ></datePicker>
            </div>
        </div>
{{ time }}
        <div class="card">
