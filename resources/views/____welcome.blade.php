...
<div class="container">
    <div class="row">
        <div class="col-sm-6">
            <img src="{{ asset('/banner/online-medicine-concept_160901-1174.png')}}" class="img-fluid" style="border:1px solid #ccc;">
        ...
        <div class="col-sm-6">
            ...
            <div class="mt-5">
                <a href="{{url('/register')}}"><button class="btn btn-success mx-3">Register as Patient</button></a>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <th scope="row">1</th>
                            <td><img src="{{ asset('images') }}/{{$doctor->doctor->image}}"
