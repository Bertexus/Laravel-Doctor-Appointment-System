...
<div class="container">
    ...
    <div class="col-md-3">
        <div class="card">
            <div class="card-body">
                <h4 class="text-header">Doctor Information</h4>
                <img src="{{asset('images')}}/{{$user->image}}" width="100px" style="border-radius:50%; width">
                <br>
                <p class="lead">Name: {{ ucfirst($user->name) }} </p>
                <p class="lead">Degree: {{ ucfirst($user->education)}} </p>
                <p class="lead">Specialist: {{ ucfirst($user->department)}} </p>
            </div>
        </div>
    </div>
        <div class="col-md-9">
